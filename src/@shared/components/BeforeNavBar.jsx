	...
	return (
		<header className="px-5  z-10 w-full">
			<nav className="flex justify-between items-center max-container">
				<a href="/">(+261) 34 79 476 16</a>

				<div className="flex gap-2 text-lg leading-normal font-medium font-montserrat max-lg:hidden wide:mr-24">
					<select
						name="select_unit_price"
						id="id_unit_price"
						defaultValue={"MGA"}
						className="border-none text-md font-bolder focus:ring-0 focus:white focus:white">
					...
					<select
						name="select_nation_name"
						id="id_nation_name"
						className="border-none text-md font-bolder focus:ring-0">
