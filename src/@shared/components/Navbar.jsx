                ...
                <div className="flex items-center">
                    ...
                    <div className="flex items-center md:order-2">
                        ...
                        <button
                            ...
                            className="content_fa_shopping_js_jheo focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-md px-5 py-2.5 mr-2 mb-2 dark:focus:ring-yellow-900">
                            <FaShoppingCart />
                        </button>
